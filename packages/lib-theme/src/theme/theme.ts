...
import type { ConfigsPalette, PaletteType } from './theme-palette.service'
import type { ConfigsComponent } from './theme-component.service'
import type { Media, MediaName } from './theme-media.service'
import type { ConfigsScale, ScaleItem, ScaleType } from './theme-scale.service'
import type { Variable } from './theme-variable.service'
