...
describe('theme - component', () => {
  const SomeComponent: FunctionComponent = jest.fn<FunctionComponent>()
  const OtherComponent: FunctionComponent = jest.fn<FunctionComponent>()
  const parameters = {
...
describe('theme - scale', () => {
  ...
  const parameters3 = { scales: { name1: jest.fn<() => string>().mockReturnValue('mocked') } }
  const parameters4 = {
  ...
  it('returns a list of breakpoints for a given scale', () => {
    ...
    expect(item).toStrictEqual(['none', 'md'])
  })
...
describe('theme - variant', () => {
  ...
  const variant1 = jest.fn().mockReturnValue(variantObject1)
  const variant2 = jest.fn().mockReturnValue(variantObject2)
  const variant3 = jest.fn().mockReturnValue(variantObject3)
  ...
  it('returns a named variant from a namespace', () => {
    ...
    expect(variant).toStrictEqual({ ...props, ...variantObject1 })
  })
  ...
  it('returns the VariantObject2 if variant is a VariantObject2', () => {
    ...
    expect(variant).toStrictEqual({ ...props, ...variantObject2 })
  })
  ...
  it('return initial props if variant parameter is undefined', () => {
    ...
    expect(variant).toStrictEqual(props)
  })
  ...
  it('returns a named variant with composition', () => {
    ...
    expect(variant).toStrictEqual({ ...props, ...variantObject3, ...variantObject2 })
  })
  ...
  it('returns a named variant with nested props', () => {
    ...
    expect(variant).toStrictEqual({ ...props, testProps: { ...variantObject3, ...variantObject2 } })
  })
  ...
  it('merges variant configs', () => {
    ...
    expect(variant01).toStrictEqual({ ...props1, ...variantObject1 })
    expect(variant02).toStrictEqual({ ...props2, ...variantObject2 })
    expect(theme).not.toBe(newTheme)
  })
})
